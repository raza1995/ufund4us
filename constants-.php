...
{	
	if(true){ //app, live
		...
		define("STRIPE_API_VERSION","2017-01-27");
	...
	define("SUPPORT_PHONE",'555-867-5309');	
}else{
	define('DIR_NAME', 'app/');
	$DB_user = "root";
	$DB_pass = "";
	...
	//defined in code of ufund, basic info line# 581, need to ask from kurt for it, because will use main routing details rather the these 2nd
...
// define("FACEBOOK_APP_SECRET","9bd9775f80725f6245e2d774b2f2f9bb");
// define("FACEBOOK_APP_ID","596604800747638");
