...
function get_max() {
	$(".bar_group").each(function() { 
		...
		void 0!==$(this).attr("max")?$(this).data("bg_max",
		$(this).attr("max")):$(this).data("bg_max",Math.max.apply(null,t))
	})
}
...
max_arr={},$(".bar_group__bar").each(function(){in_view($(this))}),$(window).ready(function(){$(".bar_group__bar").each(function(){in_view($(this))})}),bars();