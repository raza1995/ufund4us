...
class CAMPAIGN
{
	...
	public function getdonordetail($id, $uid)
	{
		try
		{
			...
			FROM tbl_donors a WHERE a.puid = '$uid' AND a.cid NOT IN ('$id') AND
			NOT EXISTS 
	...
	public function insert_rewards($id,$cid,$uid,$reward_amt,$reward_desc,$fullname) {
		try
		{
			$stmt = $this->db->prepare("INSERT INTO tbl_rewards (cid, uid, reward_amount, reward_desc, created_by, created_date) VALUES ('$cid', '$uid', '$reward_amt', '$reward_desc', '$fullname', NOW())");
			$stmt->execute();
			return $stmt;
		}
		catch(PDOException $e)
	...
	public function update_rewards($id,$cid,$uid,$reward_amt,$reward_desc,$fullname) {
		try
		{
			$stmt = $this->db->prepare("UPDATE tbl_rewards SET reward_amount = '$reward_amt', reward_desc = '$reward_desc' WHERE id = '$id' AND cid = '$cid'");
			$stmt->execute();
			return $stmt;
		}
		catch(PDOException $e)
	...
	public function delete_rewards($id,$cid,$uid,$reward_amt,$reward_desc,$fullname) {
		try
		{
