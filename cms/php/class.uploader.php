...
class Uploader {
    ...
    private function validate($file = null){
        ...
        if($file == null){
            ...
            if($file['type'][0] == "image" && @!is_array(getimagesizeWithoutError($file['tmp']))) $errors[] = $this->error_messages['accept_file_types'];
	...
	private function generateFileName($conf, $file){
		...
		$random_string = substr(str_shuffle("_0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, $length ? $length : 30);
		$string = "";
