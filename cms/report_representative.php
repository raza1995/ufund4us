...
if(!$_SESSION['uid'])
{
	...
	if ($_SESSION['role_id'] == 2 || $_SESSION['role_id'] == 4 || $_SESSION['role_id'] == 5) {
		$oregister->redirect('dashboard.php');
	}
}
$sPageName = '<li>Reports</li><li>Representative Report</li>';
$sRepresentativeLink = 'style="color:#F3BE00"';
...
<title>Admin<?php echo sWEBSITENAME;?> - Representative Report</title>
<!-- Bootstrap Core CSS -->
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
		<div class="col-sm-12">
		  <h1 class="h1styling">Representative Report</h1>
		  <div class="line3"></div>
		  <!-- .white-box -->
          <div class="white-box white">
			...
			<? }?>
             ...
             $sCampaignData = $oCampaign->getrepresentativereport($uid, $rid);
			 ...
			 ?>
                ...
                for($i=0;$i<$iCountRecords;$i++){
					...
					$comm = ($sCampaignData[$i]['donation_sum']/100)*$sCampaignData[$i]['repcomm'];
				?>
                <tr>
                  <td><? if($sCampaignData[$i]['fld_status'] == 1){?> <i class="fa fa-fw fa-thumbs-o-up"></i><? }else{?> <i class="fa fa-fw fa-thumbs-o-down"></i> <? }?></td>
                  <td><a href="start_campaign.php?m=e&cid=<?=$sCampaignData[$i]['fld_campaign_id']?>"><?=$sCampaignData[$i]['fld_cname']?></a></td>
                  <td></td>
...
$(document).ready(function(){
    var table = $('#example1').DataTable({
		...
		"columnDefs": [
			...
			{ "width": "200px", "targets": 1 },   //Campaign Name
			...
			{ "width": "200px", "targets": 11 },   //# Of Donations Received
			...
			{ "width": "200px", "targets": 17 },   //Money Raised
			{ "width": "200px", "targets": 18 },   //Money Raised
		],
		"order": [[ 0, "asc" ]]
	});
