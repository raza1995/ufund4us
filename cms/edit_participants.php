...
)
{
		...
		$oregister->redirect('participants.php?msg=4');
		
}
else if(isset($REQUEST['m']) && $REQUEST['m'] == 'add')
{
	$sRolePId = $REQUEST['fld_role_pid'];
	$sRole = $REQUEST['fld_role'];
	$sRoleId = $REQUEST['fld_role_id'];
	...
	$oregister->redirect('participants.php?msg=3');
}
...
<title>Admin<?php echo sWEBSITENAME;?> - Edit Participants</title>
<!-- Bootstrap Core CSS -->
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
          <div class="col-sm-12">
		  <h1 class="h1styling">Edit Participant</h1>
		  <div class="line3"></div>
		  <!-- .white-box -->
   ...
   <form data-toggle="validator"  method="post">
	<div class="form-group col-sm-6">
		...
		<select class="form-control colorMeBlue noValue" name="fld_role_id" id="fld_role_id" required>
                    ...
                    <?
					$sRoleData = $oregister->getparticipantrole();
