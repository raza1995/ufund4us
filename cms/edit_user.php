...
checkSetInArrayAndReturn($REQUEST, 'm', '');
checkSetInArrayAndReturn($REQUEST, 'uid', '');
$sLeftMenuCampaignParticipant = isset($sLeftMenuCampaignParticipant) ? $sLeftMenuCampaignParticipant : null;

$sPageName = '<li><a href="users.php">Manage Users</a></li><li>Edit User</li>';
if(!$_SESSION['uid'])
{
...
if($REQUEST['m'] == 'edit')
{
	...
	$sCountry = 'United States';
	$aUserDetail = [];
	$aUserDetail['fld_role_id'] = '';
	$aUserDetail['fld_name'] = '';
	$aUserDetail['fld_lname'] = '';	
	$aUserDetail['fld_phone'] = '';
	$aUserDetail['fld_status'] = '';
	$aUserDetail['fld_email'] = '';
	$aUserDetail['sPassword'] = '';
	$aUserDetail['fld_address'] = '';
	$aUserDetail['fld_zip'] = '';
	$aUserDetail['sState'] = '';
	$aUserDetail['fld_city'] = '';
}
...
if($REQUEST['m'] == 'update')
{
		...
		$oregister->update_user($sCName,$sName,$sLName,$sEmail,$sPassword,$sPhone,$sAddress,$sCity,$sState,$sCountry,$sZipcode,$sRoleId,$iId,$SStatus);
		$oregister->redirect('users.php?msg=4');
		
}
else if($REQUEST['m'] == 'insert')
{
	$sRolePId = $REQUEST['fld_role_pid'];
	$sRole = $REQUEST['fld_role'];
	$sRoleId = $REQUEST['fld_role_id'];
	...
	$oregister->redirect('users.php?msg=3');
}
...
<title>Admin<?php echo sWEBSITENAME;?> - Edit User</title>
<!-- Bootstrap Core CSS -->
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
          <div class="col-sm-12">
		  <h1 class="h1styling">Edit User</h1>
		  <div class="line3"></div>
		  <!-- .white-box -->
   ...
   <form action=""  method="post">
	<div class="form-group col-sm-6">
		...
		<select class="form-control colorMeBlue noValue" name="fld_role_id" id="fld_role_id" required>
                     ...
                     <?
					$sRoleData = $oregister->getuserrole();
	...
	<div class="form-group col-sm-6">
		<label for="fld_cname" class="control-label">Company/Brand Name<span style="color:#FF0000">*</span></label>
		<input type="text" class="form-control" id="fld_name" name="fld_cname" placeholder="Enter Company Name" value="<?=$aUserDetail['fld_cname']?>" required>
		<div class="help-block with-errors"></div>
	</div>
