...
$(function() {
    // $('.nicescroll').css('height', ($(window).height() - 140));
    // $('.nicescroll').getNiceScroll();
    // $('.nicescroll').getNiceScroll(0).doScrollTop(1, 1);
...
//Nicescroll
 $(".sidebar").niceScroll({ cursorcolor: 'rgba(255, 255, 255, 0.2)',cursorborder: '0px', cursorwidth:'5px', cursorborderradius: '0px'});
...
function confirmDelete(){
		var check = confirm('You are about to delete this user.\nDo you want to continue?');
			if(check)
			{
				return true;
			}else{
...
function confirmCampaignDelete(){
		var check = confirm('You are about to delete this campaign\nDo you want to continue?');
			if(check)
			{
				return true;
			}else{
